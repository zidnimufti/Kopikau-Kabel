...
export const products: Product[] = [
  {
    ...
    discount: 0,
    image: "../src/img/kopisusu.png", // Changed to absolute path for local image
    category: "Kopi",
